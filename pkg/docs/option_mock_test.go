...
func (_m *MockOption) Execute(_a0 *Model) {
	_m.Called(_a0)
}
...
func (_c *MockOption_Execute_Call) Run(run func(_a0 *Model)) *MockOption_Execute_Call {
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*Model)) *MockOption_Execute_Call {
	_c.Run(run)
	return _c
}
